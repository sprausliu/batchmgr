<%@ Page Title="" Language="C#" MasterPageFile="~/pkg/pkgmast.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="pkg_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        ...
        var page = { nrws: false };
        var ss = [{ value: -1, text: "取消" }, { value: 1, text: "已提交" }, { value: 2, text: "正在配送" }, { value: 3, text: "已确认" }];
        var cells = [{ text: "TJ Auto Met", value: 1 },
{ text: "TJ Auto Solid", value: 2 },
{ text: "TJ CE", value: 3 },
{ text: "TJ Clear/Inter.", value: 4 },
{ text: "TJ E-Coat", value: 5 },
{ text: "TJ GI Other", value: 6 },
{ text: "TJ IF", value: 7 },
{ text: "TJ PFG", value: 8 },
{ text: "TJ Solvent", value: 9 },
{ text: "TJ Waterborne", value: 10 },
{ text: "TJ Wood", value: 11 }
        ];
                ...
                schema: {
                    ...
                    model: {
                        ...
                        fields: {
                            ...
                            u_cell: { type: "number", editable: false },
                            u_reason: {
                                type: "string",
                                validation: {
                                    bor: function (input) {
